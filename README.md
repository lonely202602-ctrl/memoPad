...
| 文件 | 说明 |
|------|------|
| [memoPad_0.2.1_x64-setup.exe · ~1.4MB](https://github.com/lonely202602-ctrl/memoPad/releases/download/v0.2.1/memoPad_0.2.1_x64-setup.exe) | 安装版（推荐），按当前用户安装，无需管理员 |
| [memoPad_0.2.1_x64_portable.exe · ~4.5MB](https://github.com/lonely202602-ctrl/memoPad/releases/download/v0.2.1/memoPad_0.2.1_x64_portable.exe) | 便携版，单文件双击即用，删除即卸载 |
...
构建产物：
- 安装包：`src-tauri/target/release/bundle/nsis/memoPad_0.2.1_x64-setup.exe`
